...
import {ScrollView, Text, TextInput, Button, Alert, TouchableOpacity, ToastAndroid, View,Image} from "react-native";
    ...
    return (
      <ScrollView contentContainerStyle={{ padding: 20 ,paddingBottom: 20 , paddingEnd: 20, paddingTop:30}}>
          <View style={{ flexDirection: 'row' }}>
              ...
              <Text style={{ fontWeight: 'bold', fontSize: 24, color: 'black', flex: 1, textAlign: 'center' }}>
                  MOVIE QUIZ
              </Text>
              <Icon name='popcorn' size={30} color="#B23B23" />
          </View>
        ...
        <InputBox label="User ID:" onChangeText={(text) => setID(text)}/>
          ...
          <Image source={require('./img/Tangledjpg.jpg')} style={{ width: 350, height: 200 }} />
          <Text style={{ fontSize: 20 , color:"#800080"}}>  How many years was rapunzel stuck in her tower? </Text>
          <RNPickerSelect
          ...
          <Image source={require('./img/ratatouille_tall.jpg')} style={{ width: 350, height: 550 }} />
          <Text style={{ fontSize: 20 , color:"#00008B"}}> Guess the character names:</Text>
          <RNPickerSelect
          ...
          <Image source={require('./img/Elementals.jpg')} style={{ width: 350, height: 300 }} />
          <Text style={{ fontSize: 20, color:"#FFA500s"}}> Guess the Movie:</Text>
          <RNPickerSelect
